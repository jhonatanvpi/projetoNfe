...
<html lang="pt-br">
    <head>
        ...
        <!-- EMISSOR NFE -->
        <script src="resources/emissornfe/js/nfe-tmporario.js"></script>
    ...
    <body style="zoom: 85%;">
           <nav class="navbart">
            <div class="container-fluid" align="center">
                <a onclick="novo()"class="btn btn-info" ata-toggle="modal" data-target="#myModal">
     ...
     <div class="modal fade" id="pesquisarModal" tabindex="50" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog-esp">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="myModalLabel">Nova Nota Fiscal Eltrônica</h4>
          </div>
                        ...
                        <div class="form">
                          Natureza da Operação
                            <select  id="tipoData" class="form-control" onchange="carregarDataAtual()">
                                <option value="Selecione" readonly>Selecione</option>
                        ...
                        <div class="form">
                          Tipo Pagamento
                            <select  id="tipoPagamento" class="form-control" >
                                <option value="Selecione" readonly>Selecione</option>
                                <option value="0" readonly>Pagamento à vista</option>
        ...
        <div class="modal-body">
               <nav class="navbart">
            <div class="container-fluid" align="center">
                <a onclick="emitirNfe()" class="btn btn-info">
                    <span class="glyphicon glyphicon-floppy-disk"></span> Emitir NFE
                </a>     
        </div>
