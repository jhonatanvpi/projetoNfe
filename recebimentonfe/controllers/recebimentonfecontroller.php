...
class recebimentonfecontroller extends CI_Controller {
    ...
    public function index() {
        $this->load->view('recebimentonfeview');
    }
    ...
    public function emitirNfe() {
        ...
        $this->load->model('recebimentonfemodel');

        $retorno = $this->recebimentonfemodel->emitirNfe();
    ...
    public function xmlParser(){
        ...
        $retorno = $this->recebimentonfemodel->xmlParser($enderecoXml);
    ...
    public function carregarEmpresas() {
        ...
        $retorno = $this->recebimentonfemodel->carregarEmpresas();
    ...
    public function getGrid() {
        ...
        $this->load->model('recebimentonfemodel');
        $retorno = $this->recebimentonfemodel->getGrid($draw,$CNPJFiltro,
                                                   $dataInicialFiltro,
                                                   $dataFinalFiltro);
        echo json_encode($retorno);
    ...
    public function selecionaGrid(){
        ...
        $retorno = $this->recebimentonfemodel->selecionaGrid($ID,$destCNPJ);
