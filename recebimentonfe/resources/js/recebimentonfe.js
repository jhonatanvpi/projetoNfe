...
function selecionarXml(file,cont){
    ...
    $.ajax({
            url: 'index.php?m=recebimentonfe&c=recebimentonfecontroller&f=salvarAnexoXml',
            type: 'POST',
            cache: false,
            data: xml,
            processData: false,
            ...
            success: function (enderecoAnexo) {
                    ...
                    $.ajax({
                        url: 'index.php?m=recebimentonfe&c=recebimentonfecontroller&f=xmlParser',
                        data: {
...
function carregarEmpresas() {
    ...
    $.ajax({
        url: 'index.php?m=recebimentonfe&c=recebimentonfecontroller&f=carregarEmpresas',
        data: {
        },
        type: 'POST',
        dataType: 'json',
...
function emitirNfe(){
    ...
    $.ajax({
        url: 'index.php?m=recebimentonfe&c=recebimentonfecontroller&f=emitirNfe',
        data: {
...
function getGrid() {
    ...
    tableGrid = $('#grid').DataTable({
        "destroy":true,
        ajax: {
            "url": "index.php?m=recebimentonfe&c=recebimentonfecontroller&f=getGrid",
            "data": objFiltro,
            "type": "POST"
        },
        language: {
...
function selecionaGrid(ID,destCNPJ){
    ...
    $.ajax({
        url: 'index.php?m=recebimentonfe&c=recebimentonfecontroller&f=selecionaGrid',
        data: {
            ID: ID,
            destCNPJ : destCNPJ
        },
